...
| 下一步 | 執行內容 |
|--------|---------|
| 步驟 1 | 依照 `prompts/01-read-inputs.prompt.md` 執行 |
| 步驟 2 | 依照 `prompts/02-extract-requirements.prompt.md` 執行 |
| 步驟 3 | 依照 `prompts/03-clarify-requirements.prompt.md` 執行 |
| 步驟 4 | 依照 `prompts/04-analyze-requirements.prompt.md` 執行 |
| 步驟 5 | 依照 `prompts/05-generate-spec.prompt.md` 執行 |
| 步驟 6 | 依照 `prompts/06-generate-design-ready.prompt.md` 執行 |
| 步驟 7 | 依照 `prompts/07-update-versions.prompt.md` 執行 |
